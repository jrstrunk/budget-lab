...
pub fn categorize(categorizers: List(TransactionCategorizer), desc) {
  list.find(categorizers, fn(categorizer) {
    regex.check(categorizer.regex, desc)
  })
...
INSERT INTO transaction_categories VALUES
  ...
  ('GRAND CENTRAL BAG LANCASTER PA', 'Food',           'Eating Out', 'Expense'),
  ...
  ('THE HOME DEPOT', 'Discretionary', 'Shopping', 'Expense'),
  ('Joann stores', 'Discretionary', 'Shopping', 'Expense'),
  ('Lowes', 'Discretionary', 'Shopping', 'Expense'),
  ...
  ('Steamgames.com','Discretionary', 'Entertainment', 'Expense')
"
